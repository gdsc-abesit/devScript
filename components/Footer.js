...
import { Box, Container, Image, Grid, Heading, Text } from 'theme-ui'
...
const Base = styled(Box)`
  ...
  a {
    color: ${props => props.dark ? '#1db254' : '#1db254'};
    ...
    return (
        ...
        >
            <Container px={[3, null, 4]}>
                ...
                >
                    <Box>
                        <Heading as="h1" variant="subheadline" mb={3}>
                            DevScript
                        </Heading>
                        <Link href="/philosophy" passHref>Register yourself</Link>
                        <Link href="/team" passHref>Code of Conduct</Link>
                        <Link href="/jobs" passHref>Jobs</Link>
                    ...
                    <Box>
                        ...
                        <Link href="https://jams.hackclub.com/">GDSC ABESIT</Link>
                    ...
                    <Box sx={{ width: '100%', display: 'flex' }}>
                        ...
                        <Grid style={{ width: '100%' }}>
                            ...
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3499.454478398674!2d77.44524521448967!3d28.634270482409474!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce3e12347f3f3%3A0x448ab8d3630f9f35!2sYour%20Location!5e0!3m2!1sen!2sin!4v1637091611197!5m2!1sen!2sin" width="600" height="250" style={{ border: 0 }} allowfullscreen="" loading="lazy"></iframe>

                        </Grid>
                    </Box>
                </Grid>
                <Text as="p" variant="caption" sx={{ mt: 3 }}>
                    © {new Date().getFullYear()} DevScript (ABES Institute of Technology)
                </Text>
            </Container>
        </Base>
    )
